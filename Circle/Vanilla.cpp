...
int main()
{
    ...
    do
    {
       ...
       if(a=="1") {
            ...
            cout<<"[6] Mencari Diameter dari Luas"<<endl;
            cout<<"======================================"<<endl;
            ...
            system("cls");
                if(d=="1"){
	          	...
	          	if(j=="1"){
				    ...
				    cout<<endl;
				    cout<<"==================================="<<endl;
                    cout<<"Keliling lingkaran adalah  : "<<22*(jari*2)/7<<endl;
                    cout<<"==================================="<<endl;
				  }
				else{
	            ...
	            if(pi==1){
					...
					if(d=="3"){
		            	...
		            	if(j=="1"){
		            		...
		            		cout<<"Masukan Tinggi Kerucut       : ";cin>>t;
		            		cout<<"==========================================="<<endl;
		            		pelukis=sqrt(((diameter/2)*(diameter/2))+(t*t));
					...
					if(d=="5"){
					    ...
					    if (jari2 >= 0) {
							    ...
							    cout<<endl;
							    cout<<"==================================="<<endl;
					           	cout<<"Jari-jari Kerucut adalah : " << jari2 << endl;
					           	cout<<"==================================="<<endl;
						        }
					}
					if(d=="6"){
						...
						if (jari >= 0) {
							    ...
							    cout<<endl;
							    cout<<"==================================="<<endl;
					           	cout<<"Diameter Kerucut adalah  : " << diameter << endl;
					           	cout<<"==================================="<<endl;
					        }
					...
					if(d=="8"){
	            		...
	            		cout<<"Masukan Tinggi Kerucut    : ";cin>>t;
	            		cout<<"==================================="<<endl;
	            		diameter=(sqrt(v*7*3/(22*t)))*2;
	            		cout<<"Jika Phi yang digunakan adalah 22/7"<<endl;
	            		cout<<"Maka ";
	            		sleep(1);cout<<". ";sleep(1);cout<<". ";sleep(1);cout<<". ";sleep(1);
					    cout<<endl;
					    cout<<"==================================="<<endl;
	            		cout<<"Diameter Kecurut adalah   : "<<diameter<<endl;
	            		cout<<"==================================="<<endl;
					}
					if(d=="9"){
		           	 	cout<<"[1] Jari-Jari"<<endl;
			...
			if(b=="1"){
	            ...
	            if(pi==1){
					...
					if(d=="4"){
						    ...
						    cout<<endl;
						    cout<<"==================================="<<endl;
		            		cout<<"Diameter Bola adalah     : "<<diameter<<endl;
		            		cout<<"==================================="<<endl;
					}
					if(d=="5"){
			...
			if(b=="2"){
	            ...
	            if(pi==1){
					...
					if(d=="4"){
						    ...
						    cout<<endl;
						    cout<<"==================================="<<endl;
		            		cout<<"Diameter setengah Bola adalah   : "<<diameter<<endl;
		            		cout<<"==================================="<<endl;
					}
					if(d=="5"){
		...
		cout<<"."<<endl;
		cout<<"==================================="<<endl;
		cout<<"Hitung Operasi Lain (ya/tidak) : ";cin>>balen;
		cout<<"==================================="<<endl;
		system("cls");
    }
    while (balen=="ya");
